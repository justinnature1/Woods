...
public class OldPlayer extends Block
{
    ...
    public OldPlayer(int xArrayLocation, int yArrayLocation, Color aColor, float width, float height, String name)
    {
    ...
    {
        OldPlayer OldPlayer = new OldPlayer(xArrayLocation, yArrayLocation, Color.RED, width, height, name);
        return OldPlayer;
    }
